<?php
	// ########################################################################
	// GItemStats with WoWhead Support
	// Original Code By Gryphon http://www.gryphonllc.com
	// Itemstats Code by Yahourt
	// WoWhead Support for original Itemstats by Fenuz
	// WoWhead Support for GItemStats By tuaguild
	// You are free to distribute by how you wish
	// ########################### SVN INFO ###################################
	// $Id: functions_gitemstats.php 749 2007-10-30 16:04:20Z tuaguild $
	// $Rev: 749 $
	// $LastChangedBy: tuaguild $
	// $Date: 2008-06-10 09:04:20 -0500 (Tue, 10 June 2008) $
...
include_once(DIR . '/itemstats/includes/wowhead.php');
...
class ItemStats
{
	...
	function updateItemFromName($name)
	{
        ...
        //=============== DEBUT XML_CACHE =============================================================
        // On vï¿½rifie qu'il y a pas un fichier dans xml_cache
        // POUR LA RECHERCHE DE FICHIER CACHE, il faut encodï¿½ le nom en UTF8 sinon la recherche est mauvaise quand le nom comporte des accents.
        $search_name = utf8_encode($name);
        // On fait attention aux failles de sï¿½curitï¿½
        ...
        // On vï¿½rifie si il y a pas un fichier cache pour cet objet, ca permet de crï¿½er les objets qu'on a envie.
        if (file_exists(path_cache . $search_name))
        {
            if (debug_mode == true)
                echo "Object found !<br/><br/>";

            //echo "Fichier cache trouvï¿½ !<br/>";
